            ...
            <div class="card-body">
                <form action="{{ route('users.update', $user->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $user->name) }}" placeholder="Contoh: Gus Khamim">
                        @if (count($errors) > 0)
                            @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $user->email) }}" placeholder="Contoh: info@theorigin.id">
                        @if (count($errors) > 0)
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Masukkan Kata Sandi Baru...">
                        @if (count($errors) > 0)
                                @error('password')
                                <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <input id="password-confirm" type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" placeholder="Konfirmasi Kata Sandi Baru..." autocomplete="new-password">
                        @if (count($errors) > 0)
