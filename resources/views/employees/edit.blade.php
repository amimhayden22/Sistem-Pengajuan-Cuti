                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="date_of_birth" type="date" class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth" value="{{ old('date_of_birth', $employee->date_of_birth) }}" required autocomplete="date_of_birth">
                                        @if (count($errors) > 0)
                                            @error('date_of_birth')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select id="religion" type="text" class="form-control select2 @error('religion') is-invalid @enderror" name="religion" required autocomplete="religion">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="education" type="text" class="form-control select2 @error('education') is-invalid @enderror" name="education" required autocomplete="education">
